...
static mp_obj_t debug_log_out(mp_obj_t log)
{
...
MP_DEFINE_CONST_FUN_OBJ_1(native_debug_log_out, debug_log_out);


static mp_obj_t info_log_out(mp_obj_t log)
{
    const char *msg = mp_obj_str_get_str(log);
    if (NULL == msg) {
        amp_error(MOD_STR, "ulog fail to get output format msg");
...
MP_DEFINE_CONST_FUN_OBJ_1(native_info_log_out, info_log_out);


static mp_obj_t warn_log_out(mp_obj_t log)
{
    const char *msg = mp_obj_str_get_str(log);
...
MP_DEFINE_CONST_FUN_OBJ_1(native_warn_log_out, warn_log_out);


static mp_obj_t error_log_out(mp_obj_t log)
{
    const char *msg = mp_obj_str_get_str(log);
...
MP_DEFINE_CONST_FUN_OBJ_1(native_error_log_out, error_log_out);


static mp_obj_t fatal_log_out(mp_obj_t log)
{
    const char *msg = mp_obj_str_get_str(log);
...
MP_DEFINE_CONST_FUN_OBJ_1(native_fatal_log_out, fatal_log_out);
