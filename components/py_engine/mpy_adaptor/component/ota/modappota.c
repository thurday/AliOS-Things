...
static mp_obj_t ota_upgrade(mp_obj_t param)
{
    int res = -1;
    // int js_cb_ref;
...
static mp_obj_t py_ota_verify(mp_obj_t param)
{
    int res = -1;
    //int js_cb_ref;
...
static mp_obj_t ota_download(mp_obj_t param)
{
    int res = -1;
    int js_cb_ref;
...
static mp_obj_t ota_report(mp_obj_t param)
{
    int res = -1;
    int js_cb_ref;
...
static mp_obj_t ota_init(mp_obj_t param)
{
    int res = -1;
